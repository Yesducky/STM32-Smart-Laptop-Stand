...
ButtonCoordinates ResetButton = { { 290, 60 }, { 210, 10 } };
ButtonCoordinates AutoButton = { { 190, 60 }, { 100, 10 } };
ButtonCoordinates UpButton = { { 90, 220 }, { 30, 165 } };
...
//		 snprintf(str3,32,"%d", temp);
//		 LCD_Clear(50,100,50,30,0xFFFF);
//		 LCD_DrawString(50, 100, str1);
//		 LCD_DrawString(50, 115, str2);
//		 LCD_DrawString(50, 130, str3);
